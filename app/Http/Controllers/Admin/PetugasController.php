...
class PetugasController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('petugas.index')->with('success', 'Tambah Petugas Berhasil');
    }
    ...
    public function update(Request $request, $id_petugas)
    {
        ...
        return redirect()->route('petugas.index')->with('success', 'Edit Petugas Berhasil');
    }
    ...
    public function destroy($id_petugas)
    {
        ...
        if (!$tanggapan) {
            ...
            return redirect()->route('petugas.index')->with('success', 'Hapus Petugas Berhasil');
        } else {
